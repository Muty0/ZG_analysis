...
def VARIABLES(samples,mass,key,event_num):
    ...
    VARIABLES = {
            ...
            'muon1_pt':tem_Muon[:,0].pt,#samples.Muon[:,0].pt,
            'muon2_pt':tem_Muon[:,1].pt,#samples.Muon[:,1].pt,
            'muon1_eta':tem_Muon[:,0].eta,#samples.Muon[:,0].eta,
            'muon2_eta':tem_Muon[:,1].eta,#samples.Muon[:,1].eta,
            'muon_mass':mass,
            }
    if key != 'data':
